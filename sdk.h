...
enum offsets : std::int32_t {
	...
	GlobalAnimRateScale = 0xA60,
	Mesh = 0x318,
	bIsReloadingWeapon = 0x358,
	VehicleAttributes = 0x10C8,
	CachedSpeed = 0xCEC,
	TopSpeedCurrentMultiplier = 0x950,
	PushForceCurrentMultiplier = 0x954,
	WaterEffectsVehicleMaxSpeedKmh = 0x7E4,
	bAdsWhileNotOnGround = 0x53D8,
	bIgnoreTryToFireSlotCooldownRestriction = 0x11A9,
	ZiplineState = 0x22C8,
	TriggerType = 0xB1C,
	WeaponData = 0x450,
};
